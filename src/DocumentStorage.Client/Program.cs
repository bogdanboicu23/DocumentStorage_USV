...
builder.Services.AddScoped<DocumentService>(provider =>
{
    ...
    return new DocumentService(httpClientFactory, authStateProvider, logger, configuration);
});
...
builder.Services.AddScoped<AuthService>(provider =>
{
    ...
    var configuration = provider.GetRequiredService<IConfiguration>();
    return new AuthService(httpClientFactory, authStateProvider, jsRuntime, logger, configuration);
});
