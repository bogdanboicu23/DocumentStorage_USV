...
namespace DocumentStorage.Client.Services
{
    public class DocumentService
    {
        ...
        public DocumentService(IHttpClientFactory httpClientFactory, ServerAuthStateProvider authStateProvider, ILogger<DocumentService> logger, IConfiguration configuration)
        {
